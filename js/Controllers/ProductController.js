...
export default class ProductController{
    ...
    load=()=>{
        ...
        if(obj!==null){
            obj.forEach(e=>{
                let prod=new Product(e.id,e.sku,e.name,e.price,e.descriptions,e.category,e.create_date,e.stock);
    ...
    create=(sku,name,price,weight,descriptions,category,create_date,stock)=>{
        let id;
        ...
        let product=new Product(id,sku,name,price,weight,descriptions,category,create_date,stock);
